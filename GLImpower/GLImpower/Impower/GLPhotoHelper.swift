...
class GLPhotoHelper: UIImagePickerController {
    ...
    func showSelecteAlertView(didSelectedBlock: @escaping selectedBlock) {
    ...
    func creatWithScourceType(type: UIImagePickerControllerSourceType, block:@escaping selectedBlock)  {
